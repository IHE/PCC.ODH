...
InstanceOf: IHE.ODH.OccupationalDataForHealth
Description: """
...
* component[odh-PastOrPresentIndustry].valueCodeableConcept.coding[+] = $ISCO08#5322 "Home-based Personal Care Workers"
...
* component[odh-OccupationalHazard].valueString = "Infectious Disease"
* component[odh-WorkSchedule].code = $loinc#74159-5 "Work schedule NIOSH"
* component[odh-WorkSchedule].valueCodeableConcept = http://terminology.hl7.org/CodeSystem/v3-ObservationValue#RSWN "rotating shift with nights"
* component[odh-WeeklyWorkDays].code = $loinc#74160-3 "Work days per week"
* component[odh-WeeklyWorkDays].valueQuantity = 5 'd' "d"
//* component[odh-DailyWorkHours].code = $loinc#87512-0 "Work hours per day"
* component[odh-DailyWorkHours].valueQuantity = 8 'h' "h"
