Profile: OccupationalDataForHealth
Parent: Composition
Id: IHE.ODH.OccupationalDataForHealth
Title: "Occupational Data For Health"
Description: """
This Composition covers information about a patient's work, including some voluntary work, or a patient's household members' work. ODH is designed for the social history section of a medical record, to facilitate clinical care in multiple disciplines and delivery environments. ODH can be used for clinical decision support, population health activities and value-based care, and public health reporting. 
"""
//* ^version = "1.0.0"
//* ^status = #draft
...
//* category 0..1
// de-constrained, channges should be alligned in hl7

* section 1..1
* section ^short = "Section in the OccupationalDataForHealth composition, containing the person's occupational data, past and present"
* section ^definition = "Section in the OccupationalDataForHealth composition, containing the person's occupational data, past and present."
* section.author only Reference(Practitioner or PractitionerRole or Device or Patient or RelatedPerson or Organization)
* section.entry 1..* 
...
* section.entry ^slicing.discriminator.path = "reference.resolve()"
* section.entry ^slicing.discriminator.path = "code"
